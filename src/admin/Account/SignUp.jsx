      ...
      <section className="m-8 flex">
        ...
        <div className="w-full lg:w-3/5 flex flex-col items-center justify-center">
          <div className="text-center">
            ...
            >
              Vui lòng điền thông tin admin mới.
            </Typography>
          </div>
          ...
          >
            ...
            <div className="flex">
              <Checkbox containerProps={{ className: '-ml-2.5' }} />
            ...
            <div className="space-y-4 mt-8">
              <Button
                size="lg"
                color="white"
                className="flex items-center gap-2 justify-center shadow-md py-4"
                fullWidth
              >
                <svg
                  width="17"
            ...
            >
              Bạn đã có tài khoản?
              <Link to="/sign-in" className="text-gray-900 ml-1 underline">
                Đăng nhập
              </Link>
            </Typography>
          </form>
