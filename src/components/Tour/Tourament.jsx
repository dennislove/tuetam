...
function Tourament() {
  ...
  return (
    <div className='max-w-[1300px] lg:m-auto md:mx-10 sm:mx-16 relative'>
        <div className='font-normal  md:text-[40px] sm:text-[35px] pm:text-[30px] text-yellow-600 capitalize font-oxa text-center'>TUỆ TÂM</div>
        <div className='font-semibold  lg:text-[30px]  sm:text-[26px] pm:text-[22px] text-white capitalize font-pop text-center'>Tiêu Chí Hàng Đầu</div>
        ...
        <div className='mt-[50px]  grid  md:grid-cols-5 sm:grid-cols-2 pm:grid-cols-1'>
            ...
            <div className='col-span-2 md:mx-auto pm:mx-10'><Accourdion items={touraments}/></div>
        </div>
    </div>
  )
}
