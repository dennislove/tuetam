    ...
    <div className=' relative'>
        <div className='p-5 absolute flex gap-5 md:bottom-1/2 md:right-[60%] sm:right-1/2 sm:bottom-1/2 pm:mx-2 pm:right-0 pm:bottom-0 rounded-lg bg-[#00000030]'>
            <Link to='/gioi-thieu' className=' '>
                <button className=" relative lg:px-8 md:px-6 lg:py-4 md:py-2 pm:px-6 pm:py-2 border-2 border-yellow-600 font-semibold text-white rounded-lg transition-all bg-yellow-600
                          duration-1000 ease-in-out inline-block overflow-hidden capitalize shadow-md hover:bg-transparent hover:yellow-600
