...
function ButtonOutLine({name, onClick = () => {}}) {
  return (
    <button onClick={onClick}
     className=" cursor-default lg:px-8 md:px-6  lg:py-4 md:py-2 pm:px-6 pm:py-2 border-2 border-yellow-600 font-semibold text-yellow-600 rounded-lg transition-all 
