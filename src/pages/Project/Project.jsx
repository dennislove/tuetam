       ...
       <div className=' max-w-[1300px] m-auto relative pt-10'>
        <div className='relative text-center '>
            <div className=' text-center '>
                <h2 className=' font-oxa font-normal text-[40px] text-yellow-600 capitalize'>Dịch vụ</h2>
            </div>
            ...
            <div className=" px-4 mx-auto max-w-screen-xl lg:py-4 lg:px-6">
              <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                  <h4 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Bảng giá quảng cáo</h4>
           ...
           <div className="bg-[url(images/bginterview.png)] bg-cover px-4 pt-3 pb-10 ">
             <div className='my-10 text-center '>
                  ...
                  <h4 className=' mt-3 font-normal text-base text-white italic '>NV Bán hàng - NV Sản xuất - NV Đóng gói - NV Điều chế - NV Marketing</h4>
              </div>
